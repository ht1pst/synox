...
function ProjDetailsHero(){
  ...
  const [mobileMenu, setMobileMenu] = useState(false);
   ...
   return(
    <section className=" lg:h-120 h-80 relative overflow-hidden">
                      ...
                      <div className="relative lg:pt-30 pt-10">
                                             <div className="absolute top-15 left-15 lg:block hidden"><img src={dollar1} alt="" className="w-14 blur-[4px]" /></div>
                                              <div className="absolute top-25 right-50 lg:block hidden"><img src={dollar2} alt="" className="w-16 " /></div>
                                               ...
                                               <div className="absolute bottom-[-110px] right-100 lg:block hidden "><img src={dollar4} alt="" className="w-8 blur-[3px] " /></div>
                                              <div className="absolute left-0 lg:bottom-[-140px] bottom-[-115px] "><img src={bread1} alt="" className="lg:w-full w-50" /></div>
                                              <div className="absolute right-0 lg:bottom-[-140px] bottom-[-115px] "><img src={bread2} alt="" className="lg:w-full w-50"  /></div>
                                             <div className="absolute top-[-640px] opacity-10 lg:block hidden"><img src={nate} alt="" /></div>
                                             <h1 className="lg:text-[70px] text-[42px] text-white flex justify-center   ">Our Services</h1>
                                            <div className="flex justify-center gap-2">
                                             <a href="#" className="text-[#C6C6B6] lg:text-[22px] text-[20px] ">Projects Details</a>
                                             <a href="#" className="text-[#C6C6B6] lg:text-[22px] text-[20px">_</a>
                                             <a href="#" className="text-[#C6C6C6] lg:text-[22px] text-[20px] ">Projects Details</a>
                                            </div>
                                         </div>
    </section>
   ) 
}
export default ProjDetailsHero;