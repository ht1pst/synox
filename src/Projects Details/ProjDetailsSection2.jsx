...
<div className="flex flex-col lg:flex-row justify-center lg:gap-35 gap-5 mt-5">
...
<div className="lg:px-30 relative">
    <h1 className="lg:text-[40px] text-[30px] text-[#012A2B] mt-12">Project Requirement</h1>
    <p className="lg:text-[20px] text-[18px] text-[#6B6B6B] mt-5 leading-relaxed">Our client seeks comprehensive tax planning services to optimize their business's financial management and minimize tax liabilities effectively. They aim to enhance profitability, compliance with relevant tax regulations.</p>
...
<div className="lg:px-30 relative">
<h1 className="lg:text-[40px] text-[30px] text-[#012A2B] mt-12">solution & Result</h1>
 <p className="lg:text-[20px] text-[18px] text-[#6B6B6B] mt-5 leading-relaxed">Implementing our comprehensive tax planning strategies, tailored to the specific needs and objectives of our client's business, yielded significant benefits and outcomes. By customizing tax planning approaches and proactively managing their tax investment obligations, we helped the client optimize their financial management and minimize tax liabilities effectively.</p>

 <p className="lg:text-[20px] text-[18px] text-[#6B6B6B] mt-5 leading-relaxed">Through strategic timing of income and expenses, we maximized tax savings while ensuring compliance with relevant regulations, allowing the client to enhance profitability and improve cash flow. Our proactive opportunities for deductions,</p>
</div>


<div className="lg:px-30 ">
   <h1 className="lg:text-[40px] text-[30px] text-[#012A2B] mt-12">Our Similar Projects</h1> 
 <div className="flex flex-col lg:flex-row justify-center gap-5 mt-7 relative">
 <div className="group lg:w-105 lg:h-110   relative overflow-hidden rounded-xl cursor-pointer">
