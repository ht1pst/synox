...
function Section4(){
   return(
    <section className="bg-[#023436ff] lg:h-230 h-550 relative overflow-hidden px-[15px]">
...
<div>
    ...
    <p className="lg:text-[20px] text-[17px] text-[#C6C6C6] lg:w-150 text-center pt-2 mx-auto ">Safety First is our motto at Synox prioritizing your financial security. Trust us for stability as you pursue your goals.</p>
</div>

<div className="flex flex-col lg:flex-row items-center gap-8 justify-center pt-10 ">
<div className="bg-[#022627ff] lg:w-100 lg:h-132 h-135 flex flex-col gap-10 px-[35px] py-[35px] rounded-xl">
...
<div className="relative bg-[#022627ff] lg:w-100 h-142 flex flex-col gap-10   rounded-xl">
 <div
...
<div className="bg-[#022627ff] relative lg:w-100 h-132 flex flex-col gap-10 px-[35px] py-[35px] rounded-xl">
