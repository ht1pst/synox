...
function OurSection2(){
    ...
    return(
        <section className="pt-20 lg:h-160 h-320 px-[15px]">
            ...
            <div className="flex flex-col lg:flex-row relative justify-center gap-7 lg:mt-30 mt-15">
              
                <div className=" lg:w-105   lg:h-45 h-70 px-[30px] py-[40px] rounded-xl bg-[#023436ff] #023436ff hover:border hover:border-[#D9FF43] transition-all duration-700 ease-in-out">
            ...
            <p className="text-[18px] text-[#C6C6C6] pt-5">At Synox we excel funding & investing, guiding strategic decisions.</p>
                  ...
                  <div className=" lg:w-105   lg:h-45 h-68 px-[30px] py-[40px] rounded-xl bg-[#023436ff] #023436ff hover:border hover:border-[#D9FF43] transition-all duration-700 ease-in-out">
           <div className="flex flex-col lg:flex-row lg:items-center items-start gap-5">
            ...
            <p className="text-[18px] text-[#C6C6C6] pt-5">We prioritize capital transparency Our commitment ensures clarity.</p>
                 ...
                 <div className=" lg:w-105   lg:h-45 h-78 px-[30px] py-[40px] rounded-xl bg-[#023436ff] #023436ff hover:border hover:border-[#D9FF43] transition-all duration-700 ease-in-out">
            <div  className="flex flex-col lg:flex-row lg:items-center items-start gap-5">
